<?php
    ...
    if(isset($_POST['btnSignin'])) {
        ...
        $freelancer = \App\Models\Freelancer::where('email', $email)->first();
        
        if($freelancer !== null)  {
            if(md5($password) == $freelancer->password) {
            ...
            setFlashMessage('error', 'Freelancer not found');
        }
        refresh();
        exit();
    }
    ...
    <div class="page page-center" style="background-image: url(assets/images/bglogin4.png); background-size: cover; background-repeat: no-repeat; background-position: center center;">
        <div class="container container-tight py-4">
            <div class="card card-md" style="border-radius: 70px;">
                <div class="card-body">
                    <h2 class="h2 text-center mb-4">Freelancer Login</h2>
                ...
                <div class="card-body">
                    <a href="login_partner.php" class="btn btn-outline-secondary w-100 rounded-pill btn-cute" style="font-size: 16px; padding: 12px;">Partner Login</a>
                </div>

            </div>
            <div class="text-center text-muted mt-3">
                Don't have account yet? <a href="register_freelancer.php" tabindex="-1">Sign up</a>
            </div>
        </div>
    </div>
<?php
