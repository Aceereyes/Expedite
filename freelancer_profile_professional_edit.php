<?php
    ...
    if(!isset($_GET['id'])) {
        ...
        redirect('freelancer_profile_professional.php');
        exit();
    }

    $record = \App\Models\Freelancer\ProfessionalQualification::find($_GET['id']);
                    ...
                    <form method="POST" class="col d-flex flex-column">
                        <div class="card-body pb-4">
                            <div class="row g-2 align-items-center mb-3">
                                <div class="col">
                                    <h2 class="page-title">Professional Qualification</h2>
                                </div>
                                <div class="col-auto ms-auto d-print-none">
                                    <a href="freelancer_profile_professional.php" class="btn">
                            ...
                            <div class="mb-3">
                                ...
                                <input type="text" class="form-control" value="<?= $record->title ?>" name="title" required>
                            </div>
                            <div class="mb-3">
