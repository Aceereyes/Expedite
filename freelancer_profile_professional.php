                    ...
                    <div method="POST" class="col d-flex flex-column" enctype="multipart/form-data">
                        <div class="card-body pb-4">
                            <div class="row g-2 align-items-center mb-3">
                                <div class="col">
                                    <h2 class="page-title">Professional Qualifications</h2>
                                </div>
...
<?php
                            $professionalQualifications = \App\Models\Freelancer\ProfessionalQualification::where('freelancer_id', freelancer()->id)->get();
                            if($professionalQualifications->count() > 0) {
...
?>
                                    <div class="card mb-2">
                                        <div class="card-body">
                                            <div class="row">
                                                <div class="col-auto">
                                                    <span class="avatar rounded"><?= strtoupper(substr($professionalQualification->institution, 0, 2))?></span>
                                                </div>
                                                <div class="col">
                                                    <div class="fw-bold"><?= $professionalQualification->institution; ?> - (<?= $professionalQualification->timeframe; ?>)</div>
                                                    <div class="text-muted"><?= $professionalQualification->title ?></div>
                                                </div>
                                                <div class="col-auto ms-auto d-print-none">
                                                    <div class="btn-list">
                                                        <a href="<?= base_url('freelancer_profile_professional_edit.php?id='.$professionalQualification->id); ?>" class="btn btn-primary d-sm-inline-block">
                                                            Edit
                                                        </a>
                                                    </div>
                                                </div>
...
<?php
    if(isset($_POST['btnAdd'])) {
        $professionalQualification = \App\Models\Freelancer\ProfessionalQualification::create([
