...
<div class="page-body">
            ...
            <div class="col-auto ms-auto">
                <div class="btn-list">
                    <span class="d-sm-inline">
                        <a href="<?= base_url("partner_funds.php"); ?>" class="btn"><i class="ti ti-arrow-left"></i> Back</a>
                    </span>
                </div>
            </div>
        </div>
  ...
  <div style="max-width: 500px; width: 100%; border: 1px solid #ccc; border-radius: 5px; box-shadow: 0 4px 8px 0 rgba(0,0,0,0.2);">
    <div style="background-color: #007bff; color: #fff; padding: 10px; border-top-left-radius: 5px; border-top-right-radius: 5px;">
      <h2 style="text-align: center; margin: 0;">Deposit Using Gcash</h2>
    </div>
    <div style="padding: 20px;">
      ...
      <div class="card" style="margin-top: 20px;">
        <div class="card-body">
          ...
          <div class="input-group">
            ...
            <input type="text" class="form-control" id="amount" placeholder="Enter Your Number" pattern="[0-9]*" title="Please enter a Valid Number">
          </div>

          <div class="form-group" style="margin-top: 30px;">
            <label class="form-label">Email Address</label>
            sophiacruz@gmail.com
          </div>
      ...
      <div class="form-group" style="text-align: center; padding-top: 20px">
            <a href="partner_gcashdepositotp.php">
