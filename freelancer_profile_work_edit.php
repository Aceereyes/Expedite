<?php
    ...
    $record = \App\Models\Freelancer\WorkExperience::find($_GET['id']);
                        ...
                        <div class="card-body pb-4">
                            <div class="row g-2 align-items-center mb-3">
                                ...
                                <div class="col-auto ms-auto d-print-none">
                                    <a href="freelancer_profile_work.php" class="btn">
                            ...
                            <div class="mb-3">
                                ...
                                <input type="text" class="form-control" value="<?= $record->job_title; ?>" name="job_title" required>
                            </div>
                            <div class="mb-3">
                            ...
                            <div class="mb-3">
                                ...
                                <textarea name="dutiesAndResponsibilities" id="dutiesAndResponsibilities"><?= $record->dutiesAndResponsibilities; ?></textarea>
                            </div>
                        </div>
