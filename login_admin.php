<?php
    ...
    if(isset($_POST['btnSignin'])) {
        ...
        $employee = \App\Models\HR\Employee::where('email', $email)->first();
        ...
        if($admin !== null)  {
            ...
            if(md5($password) == $employee->password) {
            ...
            setFlashMessage('error', 'Admin not found');
        }
        refresh();
        exit();
    }
...
?>
    <div class="page page-center" style="background-image: url(assets/images/p3.png); background-size: cover; background-repeat: no-repeat; background-position: center center;">
        <div class="container container-tight py-4">
             <div class="card card-md" style="border-radius: 70px;">
                ...
                <div class="card-body">
                    <a href="index.php" class="btn btn-outline-secondary w-100 rounded-pill btn-cute" style="font-size: 16px; padding: 12px;">Home</a>
                </div>
            </div>
        </div>
    </div>
