         ...
         <div class="row g-2 align-items-center mb-3">
            ...
            <div class="col-auto ms-auto">
                  <span class="d-sm-inline">
                     <a href="<?= base_url("freelancer_examine_qschedules.php"); ?>" class="btn">
...
?>
        ...
        <div class="form-group" style="text-align: center; padding-top: 20px">
            <a href="freelancer_examine_qanswers.php">
                <button class="btn btn-primary" id="answerBtn" style="width: 200px; border-radius: 20px;">Create an Answer</button>
            </a>
      </div>
    </div>
