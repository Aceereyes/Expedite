      ...
      <div class="container">
         <div class="row g-2 align-items-center mb-3">
            ...
            <div class="col-auto ms-auto">
               <div class="btn-list ">
                  <a href="<?= base_url("partner_examine_qhelp.php"); ?>">
                  <span class="btn btn-secondary btn-pill w-45">          
                        Help
                  </span>  
                  </a>
                  <span class="d-sm-inline">
                     <a href="<?= base_url("partner_examine.php"); ?>" class="btn">
                     ...
                     <table class="table table-vcenter">
                        ...
                        <tbody>
                           <tr>
                              ...
                              <td>
                                 <a href="partner_examine_qview.php" class="btn btn-info btn-pill w-45">
                                    View
                                 </a>
                              </td>
                           </tr>
