...
try {
	...
	$mail->isHTML(true);
	$mail->Body   .= '<p><b>'.$user_firstname.' '.$user_lastname.'</b>, <br/><b>'.$fullname_created.'</b> of <b>'.$collegesdepartment_code.' - '.$collegedepartment_name.'</b> as <b>'.$ADMIN_PRIVILEDGE_LEVEL.'</b> has been removed you as signatory.</p>';
