...
try {
	...
	$signatory_name_approved = '<b>Good day,</b><br/>The form <b>'.$file_description.'</b> submitted by <b>'.$user_firstname_owner.' '.$user_middlename_owner.' '.$user_lastname_owner.'</b> of <b>'.$colleges_department_code_owner.'</b>, has been decline by <b>'.$user_firstname.' '.$user_middlename.' '.$user_lastname.'</b> of <b>'.$colleges_department_code.'</b>.';
