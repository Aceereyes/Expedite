...
try {
	...
	$signatory_name_approved = '<b>'.$user_firstname.' '.$user_lastname.',</b> 
	<br/> Your form <b>'.$file_description.'</b> has been successfully completed by all signatories.<br/><br/>';
	...
	if($attachment == '0'){
		$mail->Body   .= '<li> <b>File Attachment:</b> NO ATTACHMENT</li>';
	}else{
		$mail->Body   .= '<li> <b>File Attachment:</b> Click <a href = "https://dlshsi.forms.mameceaafw.com/'.$file_location_attachment.'/'.$attachment.'" class="btn btn-success btn-xs"> '.$attachment.' <i>(click here to view)</i></a></li>';
	}
	$mail->Body   .= '
