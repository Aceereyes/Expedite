...
try {
    ...
    //Content
	$mail->isHTML(true);
	$mail->Subject = 'DLSMHSI ONLINE FORMS | FILE SENT TO ADMIN / MODERATOR';
	...
	$signatory_name_approved = 'The file submitted by <b>'.$user_firstname_file_sender.' '.$user_middlename_file_sender.' '.$user_lastname_file_sender.'</b> of <b>'.$colleges_department_code_file_sender.'</b> - <b>'.$user_priviledge_level_file_sender.'</b> has been successfully approved by <b>'.$ADMIN_FIRSTNAME.' '.$ADMIN_MIDDLENAME.' '.$ADMIN_LASTNAME.'</b> of <b>'.$colleges_department_code.'</b>.<br/><br/><i><b>NOTE:</b> '.$note.'</i>';
	...
	$signatory_name1 = ''.$colleges_department_code_signatory_stats.' - '.$select_user_signatory_view1['user_firstname'].' '.$select_user_signatory_view1['user_lastname'].' - (APPROVED) <a href = "mameceaafw.com/form/user.php?cieti_user_id='.$select_user_signatory_view1['user_id'].'" target = "_blank">view info</a><br/>';
	...
	<br/>
	<br/>
	Check file status ? <a href = "https://dlshsi.forms.mameceaafw.com/login.php" class="btn btn-success btn-xs"> <i class="fa fa-unlock"> Login</a>';
