...
try {
    ...
    $department_adminuser_admin = mysqli_query($conn, "SELECT * FROM user_admins WHERE user_dept = '$colleges_department_id' && user_priviledge_level = 'Admin'");
	...
	$user_fullname = ''.$department_adminuser_view_admin['user_firstname'].' '.$department_adminuser_view_admin['user_lastname'].'';
	$mail->AddCC(''.$user_email.'', ''.$user_fullname.'');
	}
	
	$department_adminuser_moderator = mysqli_query($conn, "SELECT * FROM user_admins WHERE user_dept = '$colleges_department_id' && user_priviledge_level = 'Moderator'");
	...
	$user_fullname = ''.$department_adminuser_view_moderator['user_firstname'].' '.$department_adminuser_view_moderator['user_lastname'].'';
	$mail->AddCC(''.$user_email.'', ''.$user_fullname.'');
	}
	...
	$mail->Body   .= '<p><b>'.$colleges_department_code.'</b> Admins/Moderators,<br/><b>'.$fullname.'</b> of <b>'.$colleges_department_code_sender.'</b> has been successfully sent form to be approved <b>'.$file_description.'</b> at <b>'.$colleges_department_code.'</b> attach below.</p>';
