...
try {
	...
	$signatory_name_approved = 'The form <b>'.$file_description.'</b> that you have been submitted, has been decline by <b>'.$user_firstname.' '.$user_middlename.' '.$user_lastname.'</b> of <b>'.$colleges_department_name.'</b>
	<br/>
