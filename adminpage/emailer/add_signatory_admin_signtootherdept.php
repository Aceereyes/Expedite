...
try {
	...
	$mail->Body   .= '<p><b>'.$collegesdepartment_code.'</b> Admins/Moderators, <b>'.$user_firstname.' '.$user_lastname.'</b>, has been successfully added as interdepartment signatory by <b>'.$fullname_created.'</b> of <b>'.$collegesdepartment_code.' - '.$collegedepartment_name.'</b> as <b>'.$ADMIN_PRIVILEDGE_LEVEL.'</b>.</p>';
