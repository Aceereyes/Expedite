...
try {
	...
	$signatory_name_approved = '<b>'.$fullname.',</b> <br/><b>'.$select_user_signatory_approved_view['user_firstname'].' '.$select_user_signatory_approved_view['user_lastname'].'</b> of <b>'.$colleges_department_code.'</b> has been approved your file <b>'.$file_description.'</b>.<br/><br/><i><b>NOTE:</b> '.$note.'</i>';
