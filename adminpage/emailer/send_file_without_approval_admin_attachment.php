...
try {
	...
	$mail->Body   .= '<p><b>'.$department.'</b> Admins/Moderators,<br/><b>'.$fullname.'</b>, has been successfully sent form to be approved <b>'.$file_description.'</b> at <b>'.$department.'</b> attach below.</p>';
