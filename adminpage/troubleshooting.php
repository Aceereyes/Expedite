                ...
                <div class="x_panel">
				  ...
				  <?php
					if(isset($_POST['repair_item'])){
						...
						mysqli_query($conn, "UPDATE troubleshooting SET status = '$iCheckstatus', remarks = '$remarks' WHERE id = $repair_id");
							echo '
						...
						echo '<META HTTP-EQUIV="REFRESH" CONTENT="3;URL=troubleshooting.php">';
					}
					...
					echo '
						<table id="datatable" class="table-hover table table-striped table-bordered">
							...
							<tbody>
							';
					$message=mysqli_query($conn, "SELECT * FROM troubleshooting");
